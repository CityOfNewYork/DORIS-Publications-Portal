        ...
        <Form.Group>
          <Form.Field width="16">
            <Form.Input
              label={
                <TooltippedLabel
                  tooltipContent="On the front page, the first page or in the Executive Summary (if any) of the document,
                  what is it called? 150 characters or fewer."
                  labelContent="Title"
                />
              }
        ...
        <Form.Group>
          ...
          <Form.Field width="6">
            <Form.Select
              label={
                <TooltippedLabel
                  tooltipContent="Start typing in the box (which will autofill) or use dropdown for a list of
                  the most common kinds of reports and pick the one closest to what you are submitting."
