...
class Document(db.Model):
    ...
    title             titleInfo.title          varchar(150), chief title of this resource
    subtitle          titleInfo.subTitle       varchar(150), the remainder of the title information
    ...
    abstract          abstract                 varchar(200), summary/description of document
